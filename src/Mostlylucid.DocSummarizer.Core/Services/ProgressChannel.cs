...
public static class ProgressUpdates
{
    ...
    {
        return new ProgressUpdate(ProgressType.Stage, stage, message, PercentComplete: percent, ElapsedMs: elapsedMs);
    }
    ...
    {
        return new ProgressUpdate(ProgressType.LlmActivity, stage, message, ElapsedMs: elapsedMs);
    }
    ...
    {
        return new ProgressUpdate(ProgressType.Info, stage, message, ElapsedMs: elapsedMs);
    }
    ...
    {
        return new ProgressUpdate(ProgressType.Warning, stage, message, ElapsedMs: elapsedMs);
    }
    ...
    {
        return new ProgressUpdate(ProgressType.Error, stage, message, ElapsedMs: elapsedMs);
    }
    ...
    {
        return new ProgressUpdate(ProgressType.Completed, "Complete", message, PercentComplete: 100,
...
public static class ProgressChannel
{
    ...
    {
        return Channel.CreateUnbounded<ProgressUpdate>(new UnboundedChannelOptions
        {
            SingleWriter = false,
            SingleReader = true
        });
    ...
    {
        return Channel.CreateBounded<ProgressUpdate>(new BoundedChannelOptions(capacity)
        {
            SingleWriter = false,
            SingleReader = true,
...
public static class ProgressChannelExtensions
{
    ...
    /// </summary>
    public static void WriteStage(this ChannelWriter<ProgressUpdate>? writer, string stage, string message,
        double percent = 0, long elapsedMs = 0)
    {
    ...
    /// </summary>
    public static void WriteItem(this ChannelWriter<ProgressUpdate>? writer, string stage, int current, int total,
        string? message = null, long elapsedMs = 0)
    {
    ...
    /// </summary>
    public static void WriteLlm(this ChannelWriter<ProgressUpdate>? writer, string stage, string message,
        long elapsedMs = 0)
    {
    ...
    /// </summary>
    public static void WriteInfo(this ChannelWriter<ProgressUpdate>? writer, string stage, string message,
        long elapsedMs = 0)
    {
    ...
    /// </summary>
    public static void WriteCompleted(this ChannelWriter<ProgressUpdate>? writer, string message, long elapsedMs,
        Dictionary<string, object>? data = null)
    {
