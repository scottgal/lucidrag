...
public class Florence2CaptionService
{
        ...
        CancellationToken ct)
    {
        try
        {
            ...
            _logger?.LogDebug(
                ...
                sceneDetection.SceneCount, sceneDetection.TotalFrames,
                string.Join(", ", sceneDetection.SceneEndFrameIndices), sceneDetection.AverageMotion);
    ...
    // Scene detection is now handled by SceneDetectionService (SRP)
